...
var middlewareSecret = "df8ab1e1-4f8d-455e-ac4d-0e1ae1977ea5";
//#endregion
...
var _page0 = () => import("./chunks/generic_DNGxnLg8.mjs");
var _page1 = () => import("./chunks/ai_DSLUoS2p.mjs");
var pageMap = /* @__PURE__ */ new Map([["node_modules/astro/dist/assets/endpoint/generic.js", _page0], ["src/pages/api/ai.ts", _page1]]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///C:/Users/harsh/Desktop/Cosmic/","cacheDir":"file:///C:/Users/harsh/Desktop/Cosmic/node_modules/.astro/","outDir":"file:///C:/Users/harsh/Desktop/Cosmic/dist/","srcDir":"file:///C:/Users/harsh/Desktop/Cosmic/src/","publicDir":"file:///C:/Users/harsh/Desktop/Cosmic/public/","buildClientDir":"file:///C:/Users/harsh/Desktop/Cosmic/dist/client/","buildServerDir":"file:///C:/Users/harsh/Desktop/Cosmic/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/404","isIndex":false,"type":"page","pattern":"^\\/404\\/?$","segments":[[{"content":"404","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/404.astro","pathname":"/404","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/ai","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/ai\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"ai","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/ai.ts","pathname":"/api/ai","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/roadmap/[slug]","isIndex":false,"type":"page","pattern":"^\\/roadmap\\/([^/]+?)\\/?$","segments":[[{"content":"roadmap","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/roadmap/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://cosmic-nu-ebonvercel.app","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["C:/Users/harsh/Desktop/Cosmic/src/pages/404.astro",{"propagation":"none","containsHead":true}],["C:/Users/harsh/Desktop/Cosmic/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/harsh/Desktop/Cosmic/src/pages/roadmap/[slug].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.DGv2YGWZ.mjs","\u0000virtual:astro:page:src/pages/404@_@astro":"chunks/404_BxEokA2r.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:page:src/pages/roadmap/[slug]@_@astro":"chunks/_slug__B5SWM7Dj.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Cla-XzTa.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","C:/Users/harsh/Desktop/Cosmic/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/api/ai@_@ts":"chunks/ai_DSLUoS2p.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_DNGxnLg8.mjs","C:/Users/harsh/Desktop/Cosmic/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_X0nFMN_s.mjs","C:/Users/harsh/Desktop/Cosmic/src/layouts/BaseLayout.astro?astro&type=script&index=0&lang.ts":"_astro/BaseLayout.astro_astro_type_script_index_0_lang.CKfcKnPk.js","C:/Users/harsh/Desktop/Cosmic/src/components/Nav.astro?astro&type=script&index=0&lang.ts":"_astro/Nav.astro_astro_type_script_index_0_lang.BqN7S5ES.js","C:/Users/harsh/Desktop/Cosmic/src/components/RoadmapCanvas.tsx":"_astro/RoadmapCanvas.QrZZ7gUN.js","@astrojs/react/client.js":"_astro/client.CUVH7A_N.js","C:/Users/harsh/Desktop/Cosmic/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.CL97ng2p.js","C:/Users/harsh/Desktop/Cosmic/node_modules/dompurify/dist/purify.es.mjs":"_astro/purify.es.DYqNnIWS.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["C:/Users/harsh/Desktop/Cosmic/src/layouts/BaseLayout.astro?astro&type=script&index=0&lang.ts","var e=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&(t.target.classList.add(`in`),e.unobserve(t.target))}),{threshold:.06,rootMargin:`0px 0px -16px 0px`});requestAnimationFrame(()=>document.querySelectorAll(`[data-reveal]`).forEach(t=>e.observe(t)));"],["C:/Users/harsh/Desktop/Cosmic/src/components/Nav.astro?astro&type=script&index=0&lang.ts","var e=[`dark`,`light`];function t(){let t=localStorage.getItem(`cosmic-theme`);return e.includes(t??``)?t:`dark`}function n(e){document.documentElement.setAttribute(`data-theme`,e),document.documentElement.classList.toggle(`dark`,e===`dark`);let t=document.getElementById(`themeLabel`),n=document.getElementById(`themeIcon`);t&&(t.textContent=e===`dark`?`Light`:`Dark`),n&&(n.textContent=e===`dark`?`◐`:`◑`),localStorage.setItem(`cosmic-theme`,e)}document.getElementById(`themeToggle`)?.addEventListener(`click`,()=>{n(t()===`dark`?`light`:`dark`)}),n(t());var r=document.getElementById(`mobileMenuBtn`),i=document.getElementById(`mobileMenu`),a=document.getElementById(`mobileBackdrop`);function o(){i?.removeAttribute(`hidden`),r?.setAttribute(`aria-expanded`,`true`),document.body.style.overflow=`hidden`}function s(){i?.setAttribute(`hidden`,``),r?.setAttribute(`aria-expanded`,`false`),document.body.style.overflow=``}r?.addEventListener(`click`,()=>{r.getAttribute(`aria-expanded`)===`true`?s():o()}),a?.addEventListener(`click`,s),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&s()}),i?.querySelectorAll(`a`).forEach(e=>e.addEventListener(`click`,s));var c=document.getElementById(`mainNav`);window.addEventListener(`scroll`,()=>{c?.classList.toggle(`scrolled`,window.scrollY>20)},{passive:!0});"],["C:/Users/harsh/Desktop/Cosmic/src/pages/index.astro?astro&type=script&index=0&lang.ts","var e=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&(t.target.classList.add(`in`),e.unobserve(t.target))}),{threshold:.05,rootMargin:`0px 0px -10px 0px`});requestAnimationFrame(()=>document.querySelectorAll(`[data-reveal]`).forEach(t=>e.observe(t)));"]],"assets":["/banner.png","/favicon.ico","/favicon.svg","/_headers","/_astro/client.CUVH7A_N.js","/_astro/purify.es.DYqNnIWS.js","/_astro/react-dom.nqbCeGNs.js","/_astro/RoadmapCanvas.DZ0Ws1xk.css","/_astro/RoadmapCanvas.QrZZ7gUN.js","/_astro/BaseLayout.Cl4E1hdd.css","/_astro/index.BerPl1Qb.css","/404.html","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"GBsGQoY0TAS20jbuewFpWZj6STSlDZpLyqnA8IUCbH0=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "df8ab1e1-4f8d-455e-ac4d-0e1ae1977ea5") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
